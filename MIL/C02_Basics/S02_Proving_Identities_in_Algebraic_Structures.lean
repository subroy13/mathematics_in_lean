...
namespace MyRing      -- I am working in a custom namespace
variable {R : Type*} [Ring R]
...
#check MyRing.add_zero    --- this now have the theorem inside the namespace
#check add_zero

end MyRing

#check add_zero    --- this is different from MyRing theorem
...
theorem mul_inv_rev (a b : G) : (a * b)⁻¹ = b⁻¹ * a⁻¹ := by
  rw [← one_mul (b⁻¹ * a⁻¹), ← inv_mul_cancel (a * b), mul_assoc,
  mul_assoc, ← mul_assoc b b⁻¹, mul_inv_cancel, one_mul, mul_inv_cancel, mul_one]
